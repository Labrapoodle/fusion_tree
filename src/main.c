...
int main(){
    srand(time(NULL));
    const uint64_t kMultiplier = 0b1000000010000000100000001;
    const uint64_t kOnesMask = 0b10000000100000001000000010000000;
    const uint64_t kStacker = 0b1000000010000000100000001;
